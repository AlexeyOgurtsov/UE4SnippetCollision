#include "CollMeshActor_BlockAllDynamic.h"
...
ACollMeshActor_BlockAllDynamic::ACollMeshActor_BlockAllDynamic()
{
	InitMesh(nullptr);
	RootComponent = Mesh;
...
void ACollMeshActor_BlockAllDynamic::BeginPlay()
{
	Super::BeginPlay();
	UImplHelperLib::ColorByCollisionProfile(Mesh);
}

void ACollMeshActor_BlockAllDynamic::InitCameraAndSpringArm(USceneComponent* InAttachTo)
{
...
void ACollMeshActor_BlockAllDynamic::InitMesh(USceneComponent* InAttachTo)
{
	...
	Mesh = UImplHelperLib::CreateSM_WithProfile(MeshFinder, UCollisionProfile::BlockAllDynamic_ProfileName, InAttachTo, this);
}

void ACollMeshActor_BlockAllDynamic::InitProxSphere(USceneComponent* InAttachTo)
{
	checkf(InAttachTo, TEXT("When calling %s component to attach to must be non-NULL pointer"), TEXT(__FUNCTION__));
