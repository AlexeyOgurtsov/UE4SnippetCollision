#include "DefaultMeshActor_AtRootProxPrim.h"
...
ADefaultMeshActor_AtRootProxPrim::ADefaultMeshActor_AtRootProxPrim()
{
	InitProxSphere(Mesh);
...
void ADefaultMeshActor_AtRootProxPrim::InitCameraAndSpringArm(USceneComponent* InAttachTo)
{
...
void ADefaultMeshActor_AtRootProxPrim::BeginPlay()
{
	Super::BeginPlay();
	UImplHelperLib::ColorByCollisionProfile(Mesh);
}

void ADefaultMeshActor_AtRootProxPrim::InitMesh(USceneComponent* InAttachTo)
{
...
void ADefaultMeshActor_AtRootProxPrim::InitProxSphere(USceneComponent* InAttachTo)
{
