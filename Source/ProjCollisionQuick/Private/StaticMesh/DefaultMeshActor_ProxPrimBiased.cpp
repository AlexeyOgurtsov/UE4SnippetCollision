#include "DefaultMeshActor_ProxPrimBiased.h"
...
ADefaultMeshActor_ProxPrimBiased::ADefaultMeshActor_ProxPrimBiased()
{
	InitMesh(nullptr);
	RootComponent = Mesh;
...
void ADefaultMeshActor_ProxPrimBiased::BeginPlay()
{
	Super::BeginPlay();
...
void ADefaultMeshActor_ProxPrimBiased::InitCameraAndSpringArm(USceneComponent* InAttachTo)
{
...
void ADefaultMeshActor_ProxPrimBiased::InitMesh(USceneComponent* InAttachTo)
{
...
void ADefaultMeshActor_ProxPrimBiased::InitProxSphere(USceneComponent* InAttachTo)
{
	checkf(InAttachTo, TEXT("When calling %s component to attach to must be non-NULL pointer"), TEXT(__FUNCTION__));
