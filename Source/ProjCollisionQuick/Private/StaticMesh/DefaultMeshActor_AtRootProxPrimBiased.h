...
#include "DefaultMeshActor_AtRootProxPrimBiased.generated.h"
...
UCLASS()
class ADefaultMeshActor_AtRootProxPrimBiased : public ATUActor
{
	GENERATED_BODY()

public:
	ADefaultMeshActor_AtRootProxPrimBiased();
