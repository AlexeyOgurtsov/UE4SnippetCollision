#include "CollSkelMeshActor_PrimAsRoot.h"
...
ACollSkelMeshActor_PrimAsRoot::ACollSkelMeshActor_PrimAsRoot()
{
...
void ACollSkelMeshActor_PrimAsRoot::BeginPlay()
{
	Super::BeginPlay();
	UImplHelperLib::ColorByCollisionProfile(Mesh);
}

void ACollSkelMeshActor_PrimAsRoot::InitCameraAndSpringArm(USceneComponent* InAttachTo)
{
...
void ACollSkelMeshActor_PrimAsRoot::InitMesh(USceneComponent* InAttachTo)
{
...
void ACollSkelMeshActor_PrimAsRoot::InitProxSphere(USceneComponent* InAttachTo)
{
