...
void ACollPawnBase::MyBeginPlay_Implementation()
{
	M_LOGFUNC();
}

void ACollPawnBase::BeginPlayFinished()
{
	M_LOGFUNC();
...
void ACollPawnBase::InitCameraAndSpringArm(USceneComponent* InAttachTo)
{
...
void ACollPawnBase::InitMesh(USceneComponent* InAttachTo)
{
...
void ACollPawnBase::InitProxSphere(USceneComponent* InAttachTo)
{
...
TScriptInterface<ITUController> ACollPawnBase::K2GetTUController() const
{
	return TScriptInterface<ITUController>(GetController());
}

TScriptInterface<ITUController> ACollPawnBase::K2GetTUControllerLogged(ELogFlags InLogFlags) const
{
...
TScriptInterface<ITUController> ACollPawnBase::K2GetTUControllerChecked() const
{
	TScriptInterface<ITUController> const C = K2GetTUController();	
...
ITUController* ACollPawnBase::GetTUController() const
{
	return Cast<ITUController>(GetController());
}

ITUController* ACollPawnBase::GetTUControllerLogged(ELogFlags InLogFlags) const
{
...
ITUController* ACollPawnBase::GetTUControllerChecked() const
{
	ITUController* const C = GetTUController();	
	checkf(C, TEXT("GetTUController() must return non-NULL pawn!"));
	return C;
...
AController* ACollPawnBase::GetControllerLogged(ELogFlags InLogFlags) const
{
...
AController* ACollPawnBase::GetControllerChecked() const
{
	AController* const C = GetController();	
...
APlayerController* ACollPawnBase::GetPCLogged(ELogFlags InLogFlags) const
{
...
APlayerController* ACollPawnBase::GetPC() const
{
	return Cast<APlayerController>(GetController());
}

APlayerController* ACollPawnBase::GetPCChecked() const
{
	APlayerController* const C = GetPC();	
	checkf(C, TEXT("GetController() must return non-NULL pawn!"));
	return C;
